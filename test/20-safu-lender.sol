...
import {MoneyMarketExploiter} from "src/safu-lender/MoneyMarketExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        // USDC-wBTC pair, 1000:1 ratio
        MoneyMarketExploiter exploiter = new MoneyMarketExploiter(
            address(usdcBtcPair),
            address(moneyMarket),
            address(wbtc)
        );
