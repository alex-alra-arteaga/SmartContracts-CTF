...
import { TastyExploiter } from "src/tasty-stake/TastyExploiter.sol";
...
contract Testing is Test {
    ...
    function setUp() public {
        ...
        vm.prank(admin);
        // begin reward distribution by increasing the periodFinish
    ...
    function testChallengeExploit() public {
        ...
        // tastyStaking has 10.000 butter, 100.000 STEAK
        // attacker has 1 STEAK

        tastyStaking.migrateStake(address(new TastyExploiter()), 100_000e18);
