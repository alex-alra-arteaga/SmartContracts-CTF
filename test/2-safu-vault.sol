...
import { SafuExploiter } from "src/safu-vault/SafuExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        SafuExploiter safuExploiter = new SafuExploiter();
        usdc.transfer(address(safuExploiter),10_000e18);
        safuExploiter.runExploit(address(usdc),address(safuVault));
