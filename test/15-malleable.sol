...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        // change v to 28 or 27, the contrary it is
        uint8 v_ = v == 27 ? 28 : 27;
        // change s to 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141 - s to target the symetric pair of the elliptic curve
        bytes32 s_ = bytes32(
