...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        // admin has 100USDC, 1 NFTA, 1 NFTB
        // Marketplace fee is 5%, payment token is USDC
        // 
        bonanzaMarketplace.buyItem(address(nftA), 0, address(adminUser), 0);
        bonanzaMarketplace.buyItem(address(nftB), 0, address(adminUser), 0);
