...
import { FlashExploiter } from "src/flash-loaner/FlashLoanerExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        // set DAI-USDC pool (0,5 , 0,5) 1 million each
        // deposit 100k USDC in flashLoaner

        FlashExploiter attackerContract = new FlashExploiter();
        attackerContract.runExploit(address(uniPair), address(flashLoaner));
