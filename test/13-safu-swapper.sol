...
import { console } from "forge-std/console.sol";
import { SafuSwapperExploiter } from "src/safu-swapper/SafuSwapperExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        // Pair DAI-USDC (0,5 | 0,5) 1 million each
        // create SAFU-USDC pool
        // add 200k SAFU, 100k USDC
        new SafuSwapperExploiter(address(safuPool), address(uniPair), address(usdc), address(safu)).startExploit();
